...
def build_reid_train_loader(cfg, mapper=None, **kwargs):
    ...
    for d in cfg.DATASETS.NAMES:
        dataset = DATASET_REGISTRY.get(d)(root=cfg.DATASETS.PATH, combineall=cfg.DATASETS.COMBINEALL, **kwargs)
...
def build_reid_test_loader(cfg, dataset_name, mapper=None, **kwargs):
    ...
    dataset = DATASET_REGISTRY.get(dataset_name)(root=cfg.DATASETS.PATH, **kwargs)
    if comm.is_main_process():
        dataset.show_test()
